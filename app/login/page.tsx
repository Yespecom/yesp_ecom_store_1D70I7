...
import { ArrowLeft, Phone, ShieldCheck, Timer, Undo2 } from "lucide-react"
...
export default function LoginPage() {
  ...
  const handleVerifyOtp = async (rememberMe = true) => {
    setError("")
    setInfo("")
    if (!/^\d{6}$/.test(otp)) {
          ...
          <div className="max-w-md text-center">
            ...
            <div className="flex items-center justify-center space-x-8 text-sm">
              <div className="text-center">
                <div className="text-2xl font-bold">No Passwords</div>
                <div className="text-gray-300">Fast and secure</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">10 min</div>
                <div className="text-gray-300">OTP expiry</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">SMS</div>
                <div className="text-gray-300">Or call (when available)</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center pb-8">
              ...
              <CardTitle className="text-2xl font-bold text-gray-900">Sign in with OTP</CardTitle>
